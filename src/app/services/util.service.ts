...
export class UtilService {
  is_dev = false;
  ip_server = 'http://192.168.1.2/bimaapi';
  ip_server_backend = 'http://192.168.1.2/bimaapps';
  data_user: Object;
  active_runsheet: any[];
  data_planning: any[];
  data_runsheet: any[];
  ...
  bocFisik = '';
  boc_fisik = '';
  get signatureImgPIC(): string {
    return localStorage.getItem('signatureImgPIC') || '';
  }
  set signatureImgPIC(value: string) {
    localStorage.setItem('signatureImgPIC', value);
  }
  signatureImgCustody = '';
  isLoading = false;
  token_inquiry = '';
  ...
  get denom_kertas(): any[] {
    const data = localStorage.getItem('denom_kertas');
    if (data) {
      try {
    ...
    return [
      { "id": 100000, "item": "100K", "value": "0", "total": "0", "status": "" },
      { "id": 75000, "item": "75K", "value": "0", "total": "0", "status": "" },
      { "id": 50000, "item": "50K", "value": "0", "total": "0", "status": "" },
      { "id": 20000, "item": "20K", "value": "0", "total": "0", "status": "" },
      { "id": 10000, "item": "10K", "value": "0", "total": "0", "status": "" },
      { "id": 5000, "item": "5K", "value": "0", "total": "0", "status": "" },
      { "id": 2000, "item": "2K", "value": "0", "total": "0", "status": "" },
      { "id": 1000, "item": "1K", "value": "0", "total": "0", "status": "" },
      { "id": 500, "item": "500", "value": "0", "total": "0", "status": "" },
      { "id": 100, "item": "100", "value": "0", "total": "0", "status": "" }
    ];
  }

  resetDenomKertas(): void {
    const defaultDenomKertas = [
      { "id": 100000, "item": "100K", "value": "0", "total": "0", "status": "" },
      { "id": 75000, "item": "75K", "value": "0", "total": "0", "status": "" },
      { "id": 50000, "item": "50K", "value": "0", "total": "0", "status": "" },
      { "id": 20000, "item": "20K", "value": "0", "total": "0", "status": "" },
    ...
    localStorage.setItem('denom_kertas', JSON.stringify(defaultDenomKertas));
  }

  resetDenomLogam(): void {
    const defaultDenomLogam = [
      { "id": 1000, "item": "1K", "value": "0", "total": "0", "status": "" },
      { "id": 500, "item": "500", "value": "0", "total": "0", "status": "" },
      { "id": 200, "item": "200", "value": "0", "total": "0", "status": "" },
      { "id": 100, "item": "100", "value": "0", "total": "0", "status": "" },
      { "id": 50, "item": "50", "value": "0", "total": "0", "status": "" },
      { "id": 25, "item": "25", "value": "0", "total": "0", "status": "" }
    ];
    localStorage.setItem('denom_logam', JSON.stringify(defaultDenomLogam));
  }

  set denom_kertas(value: any[]) {
    localStorage.setItem('denom_kertas', JSON.stringify(value));
  }

  get denom_logam(): any[] {
    const data = localStorage.getItem('denom_logam');
    if (data) {
      try {
        return JSON.parse(data);
      } catch {
  ...
  set denom_logam(value: any[]) {
    localStorage.setItem('denom_logam', JSON.stringify(value));
  }

  denom_kertas_ctc: any[] = [
    {
      "id": 100000,
      "item": "100K",
      "value": "0",
